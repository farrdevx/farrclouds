<?php $__env->startSection('settings::notice'); ?>
    <?php if(config('pterodactyl.load_environment_only', false)): ?>
        <div class="row">
            <div class="col-xs-12">
...
<?php /**PATH /var/www/pterodactyl/resources/views/partials/admin/settings/notice.blade.php ENDPATH**/ ?>