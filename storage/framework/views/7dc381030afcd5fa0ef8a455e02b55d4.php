<?php echo $__env->make('partials/admin.settings.nav', ['activeTab' => 'basic'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="box-body">
                        <div class="row">
                                ...
                                <div>
                                    ...
                                    <?php if(config('app.logo')): ?>
                                        <div style="margin-top: 10px;">
                                            <img src="<?php echo e(config('app.logo')); ?>" alt="Current Logo" style="max-height: 50px; max-width: 200px;" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="app:logo_size" value="<?php echo e(old('app:logo_size', config('app.logo_size', 32))); ?>" min="16" max="100" placeholder="32" />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <div class="btn-group" data-toggle="buttons">
                                        ...
                                        ?>
                                        <label class="btn btn-primary <?php if($level == 0): ?> active <?php endif; ?>">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="color" class="form-control" name="theme:primary_color" value="<?php echo e(old('theme:primary_color', config('theme.primary_color', '#8b5cf6'))); ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="color" class="form-control" name="theme:secondary_color" value="<?php echo e(old('theme:secondary_color', config('theme.secondary_color', '#7c3aed'))); ?>" />
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <select class="form-control" name="theme:card_style">
                                        <option value="gradient" <?php echo e(old('theme:card_style', config('theme.card_style', 'gradient')) == 'gradient' ? 'selected' : ''); ?>>Gradient</option>
                                        <option value="solid" <?php echo e(old('theme:card_style', config('theme.card_style', 'gradient')) == 'solid' ? 'selected' : ''); ?>>Solid Color</option>
                                        <option value="glassmorphism" <?php echo e(old('theme:card_style', config('theme.card_style', 'gradient')) == 'glassmorphism' ? 'selected' : ''); ?>>Glassmorphism</option>
                                    </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="range" class="form-control" name="theme:border_radius" min="0" max="24" value="<?php echo e(old('theme:border_radius', config('theme.border_radius', 16))); ?>" oninput="this.nextElementSibling.value = this.value + 'px'">
                                    <output><?php echo e(old('theme:border_radius', config('theme.border_radius', 16))); ?>px</output>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <select class="form-control" name="theme:animation_speed">
                                        <option value="fast" <?php echo e(old('theme:animation_speed', config('theme.animation_speed', 'normal')) == 'fast' ? 'selected' : ''); ?>>Fast (200ms)</option>
                                        <option value="normal" <?php echo e(old('theme:animation_speed', config('theme.animation_speed', 'normal')) == 'normal' ? 'selected' : ''); ?>>Normal (300ms)</option>
                                        <option value="slow" <?php echo e(old('theme:animation_speed', config('theme.animation_speed', 'normal')) == 'slow' ? 'selected' : ''); ?>>Slow (500ms)</option>
                                    </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="range" class="form-control" name="theme:text_contrast" min="0" max="100" value="<?php echo e(old('theme:text_contrast', config('theme.text_contrast', 80))); ?>" oninput="this.nextElementSibling.value = this.value + '%'">
                                    <output><?php echo e(old('theme:text_contrast', config('theme.text_contrast', 80))); ?>%</output>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div>
                                    <textarea class="form-control" name="theme:custom_css" rows="8" placeholder="/* Add your custom CSS here */"><?php echo e(old('theme:custom_css', config('theme.custom_css', ''))); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/pterodactyl/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>